...
/*
 * Original template of class made by Kinathru. Slight changes have been made for sake of this project. 
 */
public class SURFDetector {
		
    public Mat locate(Mat item, String shelf) {
        //String bookObject = item;
        String bookScene = shelf;

        System.out.println("Started....");
        System.out.println("Loading images...");

        Mat objectImage = item; 
